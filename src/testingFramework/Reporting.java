	...
	public class Reporting {
		...
		public void generateHTMLreport(String pathToReports) throws IOException, WriteException {
			...
			Label label_8 = new Label(0, 8, "8", cellFormat);
		 	...
		 	Label label_28 = new Label(1, 8, "Check flight numbers from New York to Helsinki witch coast more then 100", cellFormat);
		 	mySheet1.addCell(label_28);	
		 	
			Label label_9 = new Label(0, 9, "9", cellFormat);
		 	mySheet1.addCell(label_9);
		 	Label label_29 = new Label(1, 9, "Check all cities (departure and arrival) whitch flying without stops", cellFormat);
		    ...
		    Label label_14 = new Label(0, 14, "14", cellFormat);
		 	...
		 	Label label_34 = new Label(1, 14, "Check all flight numbers of Virgin company where meal included on board", cellFormat);
		 	mySheet1.addCell(label_34);
		 	    
		 	Label label_15 = new Label(0, 15, "15", cellFormat);
		 	mySheet1.addCell(label_15);
		 	Label label_35 = new Label(1, 15, "Check all flight numbers of Wizzair company where meal included on board, exist additional space service and is web registration", cellFormat);
		 	...
		 	Label label_39 = new Label(1, 2, "Check all arrival airports from Kiev with web registration and duty free", cellFormat);
		 	mySheet2.addCell(label_39);
		 	    
		 	Label label_40 = new Label(0, 3, "3", cellFormat);
		 	mySheet2.addCell(label_40);
		 	Label label_41 = new Label(1, 3, "Check all airlines with priority boerding quontity seats more then 50 and without meal on the board", cellFormat);
